...
def your_build_reflexion_context2(prev_code: str, failures: List[str]) -> str:
    failures_text = "\n".join(f"- {failure}" for failure in failures)
...
if __name__ == "__main__":
    ...
    run_reflexion_flow(SYSTEM_PROMPT, YOUR_REFLEXION_PROMPT, your_build_reflexion_context2)
